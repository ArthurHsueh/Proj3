...
TEST(OSMTest, MediumFile){
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.52920,-121.75658));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.52937,-121.75563));
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.52417,-121.78252));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.52397,-121.78221));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.52391,-121.78207));
...
TEST(OSMTest, LongFile){
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5553012,-121.7876287));
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5469162,-121.8019329));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5541719,-121.7685632));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5557044,-121.7686195));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5649688, -121.7599721));
    EXPECT_EQ(TempNode->AttributeCount(), 0);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "");
    EXPECT_EQ(TempNode->HasAttribute("highway"), false);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5643809,-121.7599814));
    EXPECT_EQ(TempNode->AttributeCount(), 1);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "highway");
    EXPECT_EQ(TempNode->HasAttribute("highway"), true);
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5611334,-121.7861528));
    EXPECT_EQ(TempNode->AttributeCount(), 1);
    EXPECT_EQ(TempNode->GetAttributeKey(0), "highway");
    EXPECT_EQ(TempNode->HasAttribute("highway"), true);
    EXPECT_EQ(TempNode->GetAttribute("highway"), "stop");
    ...
    EXPECT_EQ(TempNode->Location(),std::make_pair(38.5478828,-121.7128271));
